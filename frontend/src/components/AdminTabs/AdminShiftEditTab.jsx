...
export default function AdminShiftEditTab() {
  ...
  const [autoGenerateDialog, setAutoGenerateDialog] = useState(null); // { type: "success" | "error", text }
  ...
  async function handleAutoGenerate() {
    ...
    try {
      ...
      setAutoGenerateDialog({ type: "error", text: e.message || "自動生成に失敗しました。" });
    } finally {
    ...
    <div>
      ...
      {autoGenerateDialog && (
        <div
          ...
          onClick={() => setAutoGenerateDialog(null)}
        >
          <div
            style={{
              backgroundColor: "#fff",
          ...
          >
            <h3 style={{ marginTop: 0, color: autoGenerateDialog.type === "error" ? "#dc2626" : "#059669" }}>
              {autoGenerateDialog.type === "error" ? "自動生成エラー" : "自動生成結果"}
            </h3>
            <p style={{ whiteSpace: "pre-line" }}>{autoGenerateDialog.text}</p>
            <div style={{ display: "flex", justifyContent: "flex-end" }}>
              <button type="button" onClick={() => setAutoGenerateDialog(null)} style={{ padding: "0.4rem 0.8rem" }}>
                閉じる
              </button>
            </div>
          </div>
